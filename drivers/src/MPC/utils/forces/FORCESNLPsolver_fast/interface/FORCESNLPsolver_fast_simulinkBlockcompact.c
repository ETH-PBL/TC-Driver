...
#define S_FUNCTION_NAME FORCESNLPsolver_fast_simulinkBlockcompact
...
typedef FORCESNLPsolver_fastinterface_float FORCESNLPsolver_fastnmpc_float;
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 1 */
    ssSetInputPortMatrixDimensions(S,  1, 252, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 315, 1);

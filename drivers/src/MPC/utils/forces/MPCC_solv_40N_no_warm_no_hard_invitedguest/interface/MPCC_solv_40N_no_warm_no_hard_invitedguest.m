% MPCC_solv_40N_no_warm_no_hard_invitedguest - a fast solver generated by FORCESPRO v5.1.0
%
%   OUTPUT = MPCC_solv_40N_no_warm_no_hard_invitedguest(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = MPCC_solv_40N_no_warm_no_hard_invitedguest(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = MPCC_solv_40N_no_warm_no_hard_invitedguest(PARAMS) returns 

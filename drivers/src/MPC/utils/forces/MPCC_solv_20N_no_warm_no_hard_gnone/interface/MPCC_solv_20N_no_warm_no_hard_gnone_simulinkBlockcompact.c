...
#define S_FUNCTION_NAME MPCC_solv_20N_no_warm_no_hard_gnone_simulinkBlockcompact
...
#include "../include/MPCC_solv_20N_no_warm_no_hard_gnone.h" 
...
typedef MPCC_solv_20N_no_warm_no_hard_gnoneinterface_float MPCC_solv_20N_no_warm_no_hard_gnonenmpc_float;
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Solver data */
	static MPCC_solv_20N_no_warm_no_hard_gnone_params params;
	static MPCC_solv_20N_no_warm_no_hard_gnone_output output;
	static MPCC_solv_20N_no_warm_no_hard_gnone_info info;	
    ...
    #if SET_PRINTLEVEL_MPCC_solv_20N_no_warm_no_hard_gnone > 0
	...
	/* Call solver */
	exitflag = MPCC_solv_20N_no_warm_no_hard_gnone_solve(&params, &output, &info, fp );

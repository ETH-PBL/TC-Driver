 ...
 *  - FORCESNLPsolver_slow
 *  - "include/FORCESNLPsolver_slow.h"
 *  - FORCESNLPsolver_slow_casadi2forces
 *  - FORCESNLPsolver_slow_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCESNLPsolver_slow, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCESNLPsolver_slow, _solve)

#include "include/FORCESNLPsolver_slow.h"

/* Header of external evaluation function */
void FORCESNLPsolver_slow_casadi2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCESNLPsolver_slow_interface(void *params, void *outputs, void *info, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, fp, &FORCESNLPsolver_slow_casadi2forces);
}

...
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
   ...
   OUTPUT = FORCESNLPsolver_slow_py.FORCESNLPsolver_slow_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver_slow_py.FORCESNLPsolver_slow_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver_slow_py.FORCESNLPsolver_slow_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FORCESNLPsolver_slow/lib/FORCESNLPsolver_slow.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver_slow/lib/FORCESNLPsolver_slow_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver_slow_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver_slow/lib/libFORCESNLPsolver_slow_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver_slow_solve')

class FORCESNLPsolver_slow_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver_slow_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver_slow_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolver_slow_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver_slow_outputs = {'x01' : np.array([]),
'x02' : np.array([]),
'x03' : np.array([]),
'x04' : np.array([]),
'x05' : np.array([]),
...
class FORCESNLPsolver_slow_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver_slow_params_ctypes), ctypes.POINTER(FORCESNLPsolver_slow_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver_slow_info), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

def FORCESNLPsolver_slow_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolver_slow_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolver_slow_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolver_slow_outputs_ctypes()
    info_py = FORCESNLPsolver_slow_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver_slow_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), PyFile_AsFile(fp) , _lib.FORCESNLPsolver_slow_casadi2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver_slow_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), None , _lib.FORCESNLPsolver_slow_casadi2forces)
            else:
                exitflag = _lib.FORCESNLPsolver_slow_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), fp , _lib.FORCESNLPsolver_slow_casadi2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolver_slow_outputs:
        FORCESNLPsolver_slow_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolver_slow_outputs,int(exitflag),info_py

solve = FORCESNLPsolver_slow_solve

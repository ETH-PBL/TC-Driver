% FORCESNLPsolver_slow - a fast solver generated by FORCESPRO v5.1.0
%
%   OUTPUT = FORCESNLPsolver_slow(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = FORCESNLPsolver_slow(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver_slow(PARAMS) returns 

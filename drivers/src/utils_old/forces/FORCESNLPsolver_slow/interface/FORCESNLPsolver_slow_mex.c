...
static FORCESNLPsolver_slow_params params;
static FORCESNLPsolver_slow_output output;
static FORCESNLPsolver_slow_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1)
	{
		mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver_slow_mex' for details.");
	}    
	if (nlhs > 3) 
	{
	...
	#if SET_PRINTLEVEL_FORCESNLPsolver_slow > 0
	...
	/* call solver */
	exitflag = FORCESNLPsolver_slow_solve(&params, &output, &info, fp, pt2function_FORCESNLPsolver_slow);

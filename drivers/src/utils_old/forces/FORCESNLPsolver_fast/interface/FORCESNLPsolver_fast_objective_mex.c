...
typedef FORCESNLPsolver_fast_float solver_float;
...
void copyCArrayToM_FORCESNLPsolver_fast(FORCESNLPsolver_fast_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolver_fast(FORCESNLPsolver_fast_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolver_fast(double *src, FORCESNLPsolver_fast_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
        *dest++ = (FORCESNLPsolver_fast_float) (*src++) ;
    }
}

void copyMValueToC_FORCESNLPsolver_fast(double * src, FORCESNLPsolver_fast_float * dest)
{
	*dest = (FORCESNLPsolver_fast_float) *src;
}
...
extern void (FORCESNLPsolver_fast_float *x, FORCESNLPsolver_fast_float *y, FORCESNLPsolver_fast_float *l, FORCESNLPsolver_fast_float *p, FORCESNLPsolver_fast_float *f, FORCESNLPsolver_fast_float *nabla_f, FORCESNLPsolver_fast_float *c, FORCESNLPsolver_fast_float *nabla_c, FORCESNLPsolver_fast_float *h, FORCESNLPsolver_fast_float *nabla_h, FORCESNLPsolver_fast_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
FORCESNLPsolver_fast_extfunc pt2function_FORCESNLPsolver_fast = &;
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolver_fast(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolver_fast(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolver_fast(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolver_fast(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;

...
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
   ...
   OUTPUT = FORCESNLPsolver_fast_py.FORCESNLPsolver_fast_solve(PARAMS) solves a multistage problem
   subject to the parameters supplied in the following dictionary:
       PARAMS['xinit'] - column vector of length 8
       PARAMS['x0'] - column vector of length 252
       PARAMS['all_parameters'] - column vector of length 315
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver_fast_py.FORCESNLPsolver_fast_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver_fast_py.FORCESNLPsolver_fast_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FORCESNLPsolver_fast/lib/FORCESNLPsolver_fast.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver_fast/lib/FORCESNLPsolver_fast_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver_fast_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver_fast/lib/libFORCESNLPsolver_fast_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver_fast_solve')

class FORCESNLPsolver_fast_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
    _fields_ = [('xinit', ctypes.c_double * 8),
('x0', ctypes.c_double * 252),
('all_parameters', ctypes.c_double * 315),
]

FORCESNLPsolver_fast_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver_fast_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolver_fast_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver_fast_outputs = {'x01' : np.array([]),
'x02' : np.array([]),
'x03' : np.array([]),
'x04' : np.array([]),
'x05' : np.array([]),
...
class FORCESNLPsolver_fast_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver_fast_params_ctypes), ctypes.POINTER(FORCESNLPsolver_fast_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver_fast_info), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

def FORCESNLPsolver_fast_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolver_fast_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolver_fast_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolver_fast_outputs_ctypes()
    info_py = FORCESNLPsolver_fast_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver_fast_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), PyFile_AsFile(fp) , _lib.FORCESNLPsolver_fast_casadi2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver_fast_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), None , _lib.FORCESNLPsolver_fast_casadi2forces)
            else:
                exitflag = _lib.FORCESNLPsolver_fast_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), fp , _lib.FORCESNLPsolver_fast_casadi2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolver_fast_outputs:
        FORCESNLPsolver_fast_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolver_fast_outputs,int(exitflag),info_py

solve = FORCESNLPsolver_fast_solve

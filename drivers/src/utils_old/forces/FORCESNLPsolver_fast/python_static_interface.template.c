 ...
 *  - FORCESNLPsolver_fast
 *  - "include/FORCESNLPsolver_fast.h"
 *  - FORCESNLPsolver_fast_casadi2forces
 *  - FORCESNLPsolver_fast_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCESNLPsolver_fast, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCESNLPsolver_fast, _solve)

#include "include/FORCESNLPsolver_fast.h"

/* Header of external evaluation function */
void FORCESNLPsolver_fast_casadi2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCESNLPsolver_fast_interface(void *params, void *outputs, void *info, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, fp, &FORCESNLPsolver_fast_casadi2forces);
}

...
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - column vector of length 231
       PARAMS['xinit'] - column vector of length 8
       PARAMS['all_parameters'] - column vector of length 210
...
#    def from_param(self):
#        return self
    _fields_ = [('x0', ctypes.c_double * 231),
('xinit', ctypes.c_double * 8),
('all_parameters', ctypes.c_double * 210),
]

...
#define S_FUNCTION_NAME MPCC_solv_40N_no_warm_no_hard_invitedguest_simulinkBlock
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* initialize input ports - there are 243 in total */
    if (!ssSetNumInputPorts(S, 243)) return;

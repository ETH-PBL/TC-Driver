...
#define S_FUNCTION_NAME MPCC_solv_20N_no_warm_hard_invitedguest_simulinkBlock
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* initialize input ports - there are 124 in total */
    if (!ssSetNumInputPorts(S, 124)) return;
	...
	/* Input Port 123 */
    ssSetInputPortMatrixDimensions(S,  123, 1, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const solver_int32_unsigned *num_of_threads = (const solver_int32_unsigned*) ssGetInputPortSignal(S,123);
